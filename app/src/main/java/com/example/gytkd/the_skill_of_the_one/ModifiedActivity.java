...
public class ModifiedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modi_choi);
        ...
        Classification = intent.getStringExtra("분류");
        review();
        ...
        saveBt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (asave == 0 || asave ==3) {
                    ...
                    db.execSQL("update choice set qtitle='" + qtitle + "',exam1='" + example1 + "', exam2='" + example2 + "', exam3 = '" + example3 + "',exam4 = '" + example4 + "', exam5 = '" + example5 + "', answer='" + ans_choi + "', picture = '" + photous + "' where _id="+integer1+"");
                    finish();
                } else if (juge == 1) {
                    moonjaewrite = edt.getText().toString();
                    db.execSQL("update choice set qtitle='" + qtitle + "',exam1='" + example1 + "', exam2='" + example2 + "', exam3 = '" + example3 + "',exam4 = '" + example4 + "', exam5 = '" + example5 + "', answer='" + ans_choi + "', moonjaewrite = '" + moonjaewrite + "' where _id="+integer1+"");
                    finish();
                }
            }
        });
...
//이미지뷰에 이미지셋팅
    ...
    private void review() {
            Cursor cursor = db.rawQuery("select qtitle,exam1,exam2,exam3,exam4,exam5,answer,moonjaewrite,picture FROM choice where _id=" + integer1 + "", null);
            if (cursor.moveToFirst()) {
                if (cursor.getString(7).equals("nope") && !cursor.getString(8).equals("nope")) {
                    imav.setVisibility(View.VISIBLE);
                    edt.setVisibility(View.INVISIBLE);
                    Question.setText(cursor.getString(0));
                    answ1.setText(cursor.getString(1));
                    answ2.setText(cursor.getString(2));
                    answ3.setText(cursor.getString(3));
                    answ4.setText(cursor.getString(4));
                    answ5.setText(cursor.getString(5));
                    answer.setText(cursor.getString(6));
                    phoho = Uri.parse(cursor.getString(8));
                    asave = 3;
                    try {
                        Bitmap bm3 = MediaStore.Images.Media.getBitmap(getContentResolver(), phoho);
                ...
                } else if (!cursor.getString(7).equals("nope") && cursor.getString(8).equals("nope")) {
                    asave = 4;
                    imav.setVisibility(View.INVISIBLE);
                    edt.setVisibility(View.VISIBLE);
                    Question.setText(cursor.getString(0));
                    ...
                    answ5.setText(cursor.getString(5));
                    answer.setText(cursor.getString(6));
                    edt.setText(cursor.getString(7));
